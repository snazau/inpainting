...
from masking.mask_painter import mask_painter
...
if __name__ == "__main__":
    ...
    image = cv2.imread('../test_img/truck.jpg')
    ...
    cv2.imwrite('../test_img/truck_point.jpg', painted_image)
    exit()
    ...
    painted_image = mask_painter(image, masks[np.argmax(scores)].astype('uint8'), background_alpha=0.8)
    painted_image = cv2.cvtColor(painted_image, cv2.COLOR_RGB2BGR)  # numpy array (h, w, 3)
    cv2.imwrite('../test_img/truck_both.jpg', painted_image)
    ...
    painted_image = mask_painter(image, masks[np.argmax(scores)].astype('uint8'), background_alpha=0.8)
    painted_image = cv2.cvtColor(painted_image, cv2.COLOR_RGB2BGR)  # numpy array (h, w, 3)
    cv2.imwrite('../test_img/truck_mask.jpg', painted_image)