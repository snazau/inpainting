...
if __name__ == '__main__':
	...
	painted_image.save('./test_img/point_painter_1.png')
	...
	painted_image.save('./test_img/point_painter_2.png')

	# example of background remover
	input_image = np.array(Image.open('./test_img/original.png').convert('RGB'))
	image_wo_background = background_remover(input_image, input_mask)	# return PIL.Image
	image_wo_background.save('./test_img/image_wo_background.png')
